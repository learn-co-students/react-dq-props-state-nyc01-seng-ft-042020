    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog traits={offspring[0]} eyecolor={this.state.eyeColor}/>
          <BabyHog traits={offspring[1]} eyecolor={this.state.eyeColor}/>
          <BabyHog traits={offspring[2]} eyecolor={this.state.eyeColor}/>
        </ul>
